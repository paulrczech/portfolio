      ...
      <div class="copy">
        <div v-reveal class="intro-row">
          ...
          <div class="intro-text">
            ...
            <h2 class="section-heading">Reliable code, thoughtful craft.</h2>
          </div>
        </div>
        ...
        <p v-reveal="80" class="paragraph">
          Day to day, that means turning ambiguous UX requirements into modular,
          maintainable components. Increasingly, that also means using
          AI-assisted tooling like Claude Code to move faster without cutting
          corners on quality.
        </p>

        <p v-reveal="160" class="paragraph">
          I'm looking for a remote, senior-level front-end role on a team that
          cares about what the work is actually for: building something worth
          building, not just shipping features to hit a number. If that's the
          kind of team you're putting together, I'd love to talk.
        </p>
      </div>
