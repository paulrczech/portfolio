  ...
  <section id="contact" class="section">
    <div class="container contact-inner">
      ...
      <div v-reveal="90" class="actions">
        ...
        <a class="btn btn-ghost" href="https://linkedin.com/in/paul-czech" target="_blank" rel="noopener noreferrer">
          <IconLinkedin class="icon" /> LinkedIn
        </a>

        <a class="btn btn-ghost" href="https://github.com/paulrczech" target="_blank" rel="noopener noreferrer">
